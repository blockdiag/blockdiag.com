# -*- coding: utf-8 -*-
#
# blockdiag documentation build configuration file, created by
# sphinx-quickstart on Sat Sep 17 11:54:19 2011.
#
...
html_sidebars = {
    '**': ['localtoc.html', 'relations.html', 'sourcelink.html', 'searchbox.html', 'sponsors.html'],
}
...
htmlhelp_basename = 'blockdiagdoc'
...
latex_documents = [
  ('index', 'blockdiag.tex', u'blockdiag Documentation',
...
man_pages = [
    ('index', 'blockdiag', u'blockdiag Documentation',
     [u'Takeshi KOMIYA'], 1)
]
